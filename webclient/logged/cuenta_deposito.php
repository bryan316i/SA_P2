...
?>
	  ...
	  <form action="db_cuenta_deposito.php" method="post">
        <h2 class="form-heading">Depósito</h2>
...
?>
        ...
        <input type="number" step="0.01" id="inputMonto" name="monto" class="form-control" placeholder="Monto a depositar" required>
        <button class="btn btn-lg btn-primary btn-block" type="submit">Realizar depósito</button>
      </form>
